...
//	sink_PFtmp = sink_PF(Te0,Te,PFs_width,PFs_length);
  ...
  if (pos_sink_zf > 0.)
    {
/*      ddt(Ti) -= pos_sink_zf*tanhxl_core(filter_position_ti)*Ti.DC();
      ddt(Te) -= pos_sink_zf*tanhxl_core(filter_position_te)*Te.DC();
      ddt(Ni) -= pos_sink_zf*tanhxl_core(filter_position_ni)*Ni.DC();
*/
