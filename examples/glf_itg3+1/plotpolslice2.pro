...
PRO plotpolslice2, var3d_in, uedge, period=period, zangle=zangle, $
  ...
  ;STOP 
  @spenv
;here  window,/free,xsize=600,ysize=600
;  CONTOUR2, var2d, rxy, zxy, /fil, lev=lev, c_col=col;,/over
  plot, rxy, zxy, psym=3,/iso, _extra=_extra, /nodata, color=1
  CONTOUR, var2d, rxy, zxy, /fil, lev=lev, c_col=col,/over
