...
bool BScurrent,spitzer_resist,spitzer_resist_Te;
...
//*********************************************************liend 
  ...
  OPTION(options, spitzer_resist_Te,         false);
...
//   ddt(Te)=0.0; 
  ...
  ddt(Te) =   0.6667*kappa_Te*Grad2_par2(Te)/temp_Ni
   ...
   if(spitzer_resist_Te) ddt(Te) += 2.0/3.0*(Bbar*Bbar/(MU0*Ni_x*density_unit*Te_x*KB*eV_K))*eta*B0*B0*J1_para*J1_para/Ni;
