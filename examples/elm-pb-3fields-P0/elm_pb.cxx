...
//for KSTAR ============================================================
bool write_p;
Field2D P0w; //write P0
BoutReal P_0;   // potential amplitude
BoutReal P_s;   // shear parameter
BoutReal Px0;   //velocity peak location
BoutReal Psign; //direction of flow
BoutReal P_min; //constant in flow
...
int physics_init(bool restarting)
{
  ...
  OPTION(options, write_p,          true);    //KSTAR
  OPTION(options, P_0,                0.0);    //
  OPTION(options, P_s,                0.0);    //
  OPTION(options, Px0,                 0.0);    //
  OPTION(options, Psign,               1.0);    //
  OPTION(options, P_min,           3000.0);    //
  ...
  if(write_p){
    ...
    P0w = P_min+P_0*(1.0-tanh(P_s*(x-Px0)));
    P0 = P0w;
}
