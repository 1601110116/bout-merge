...
int physics_init(bool restarting)
{
 ...
 // Radial smoothing
  ...
  OPTION(options, diffusion_p004,        -1.0);   //xqx: parallel hyper-viscous diffusion for p00
...
//     output.write("Now I see you t0_2.\n");
      ...
      if (Hmode_rc_p0 && time_crt2 )
	{
	  ...
	  ddt(P00) += d2dx2p0/converge_const;
        ...
        if(diffusion_p004 > 0.0) {
          //tmpP002 = Grad2_par2new(P00);
          tmpP002 = D2DX2(P00);
          mesh->communicate(tmpP002);
          tmpP002.applyBoundary();
          //ddt(P00) -= diffusion_p004 * zonal_part(Grad2_par2new(tmpP002), low_pass_z);}
