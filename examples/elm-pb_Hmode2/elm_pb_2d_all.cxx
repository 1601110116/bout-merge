...
bool Hmode_rc, Hmode_rc_par, Hmode_rc_p0, Hmode_rc_vexp, zero_transp_bndry, Hmode_rc_phi00, iterate_phi0, Hmode_rc_U00, Hmode_rc_psi00, include_zonal_psi, include_jpar00;
...
int physics_run(BoutReal t)
{
  ...
  if(!evolve_jpar) {
    ...
    {
//      Field2D psi00_tmp;
//      psi00_tmp = smooth_x(psi00);
      Jpar00 = Delp2(psi00);
      //Jpar00 = mesh->G1*DDX(psi00) + mesh->g11*smooth_x(D2DX2(psi00));
      //Jpar00 = DDX(psi00);
