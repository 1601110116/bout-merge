...
BoutReal ***E_flux_interval, ***U_flux_interval, ***M_flux_interval;
          ...
          for (int i=0;i<mesh->ngx;i++)
            {
              ...
              for (int j=0;j<mesh->ngy;j++)
                {
                  E_flux_interval[i][j] = (double*)calloc(mesh->ngz, sizeof(BoutReal));
                  U_flux_interval[i][j] = (double*)calloc(mesh->ngz, sizeof(BoutReal));
                  M_flux_interval[i][j] = (double*)calloc(mesh->ngz, sizeof(BoutReal));
  ...
  if(evolve_jpar) {
    ...
    if (Hmode_rc2)
        ...
        if (nonlinear && include_zonal_psi && Hmode_rc_psi00 && Hmode_rc_phi00)
	  {
        ...
        if ( (time_average>0) && (!first_run) && (t == int(t)) )
          {
            for(int i=0;i<mesh->ngx;i++)
              for(int j=0;j<mesh->ngy;j++)
      ...
      if ( ( calc_interval && (int(t)%calc_interval==0) && (t == int(t)) ) || first_run )
        {
...
//                   output.write("Test 2.\n");
                  ...
                  M_flux_ave = Vexp_tave_tmp/(time_average_count);
...
//                   output.write("Test 2.\n");
                  ...
                  U_flux_ave = Vexp_tave_tmp/(time_average_count);
//output.write("Test 2.1\n");
                }
            }
          }
...
//                   output.write("Test 2.\n");
                  ...
                  E_flux_ave = Vexp_tave_tmp/(time_average_count);
//output.write("Test 2.1\n");
		}
	    }
	  }
	...
	{
	  ddt(P) -= VeXp - E_flux;
	  if ( calc_interval && (int(t)%calc_interval==0) )
...
//output.write("Test 2.2\n");
      ...
      if ( Hmode_rc_par && ( calc_interval && (int(t)%calc_interval==0) ) )
	{
...
//     output.write("Now I see you t0_2.\n");
      ...
      if (Hmode_rc_p0 && ( calc_interval && (int(t)%calc_interval==0) ))
	{
	  Field2D P00_tmp;
	  P00_tmp = Field2D(0.);
	  P0_tmp = P00;
      ...
      ddt(U00) = 0.0;
      if (Hmode_rc_phi00 && ( calc_interval && (int(t)%calc_interval==0) ) )
	{
...
*/	}
     //output.write("Now I see you t0_3.\n");
      ...
      ddt(psi00) = 0.;
      if (Hmode_rc_psi00 && ( calc_interval && (int(t)%calc_interval==0) ) )
      {
