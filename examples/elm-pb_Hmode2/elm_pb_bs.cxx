...
BoutReal aspect_ratio, bs_const;
...
int physics_init(bool restarting)
{
  ...
  OPTION(options, include_bs_jpar,  false); // include the BS current in the calculation
...
//	    U00 = zonal_part(U, low_pass_z);
	    if (Hmode_rc2 && Hmode_rc_phi00 && Hmode_rc_psi00)
	      ...
	      if (include_bs_jpar)
		bs_const = sqrt(aspect_ratio)*Bbar*Lbar/2.;
	  }
      }
  }
  else
...
/*      if (smooth_j_x)
	{
      ...
      Jpar00 = Delp2(psi00);
      if (include_bs_jpar)
        Jpar00 += bs_const*Rxy/B0*DDX(P00);
