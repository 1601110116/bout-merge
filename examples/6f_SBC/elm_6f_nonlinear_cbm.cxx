  ...
  if (compress0 && (diffusion_par > 0.0) && (gamma_i_BC > 0.0) && (gamma_e_BC > 0.0) && SBC_lim)
    {
      ...
      a_up += ((1.71+Zi*N_up/Ne0)*4.0*(Ne0+Zi*N_up)*Va*Lbar*Vi_up)/(kappa_par_e/Tepara1);

      b_up = (MU0*eta*(Nbar*density)*Va*Lbar*(Ne0+Zi*N_up)*ee*Vi_up*3.0)/(Bbar*Te0);
      b_up += (-1.0*(1.71+Zi*N_up/Ne0)*19.5*(Ne0+Zi*N_up)*(Tebar*eV_K)*Vi_up*KB)/((kappa_par_e/Tepara1)*Bbar*ee);

      c_up = (-1.0*Lbar*Va*19.5*(Ne0+Zi*N_up)*Vi_up)/(kappa_par_e/Tepara1);
      d_up = (Va*Va*Lbar*Lbar*Bbar*ee*4.0*(Ne0+Zi*N_up)*Vi_up)/((kappa_par_e/Tepara1)*(Tebar*eV_K)*KB);


      a_dw = (MU0*eta*(Nbar*density)*Va*Va*Lbar*Lbar*(Ne0+Zi*N_dw)*ee*ee*Vi_dw)/(KB*Tebar*eV_K*Te0);
      a_dw += (-1.0*(1.71+Zi*N_dw/Ne0)*4.0*(Ne0+Zi*N_dw)*Va*Lbar*Vi_dw)/(kappa_par_e/Tepara1);
      ...
      c_dw = (Lbar*Va*19.5*(Ne0+Zi*N_up)*Vi_dw)/(kappa_par_e/Tepara1);
      d_dw = (-1.0*Va*Va*Lbar*Lbar*Bbar*ee*4.0*(Ne0+Zi*N_up)*Vi_dw)/((kappa_par_e/Tepara1)*(Tebar*eV_K)*KB);
...
void Cal_Te (const Field3D &Te, Field3D &Te_up, Field3D &Te_dw, Field3D &Vi_up, Field3D &Vi_dw, Field3D &N_up, Field3D &N_dw)
{
  ...
  up1 = (delty*gamma_e_BC*Va*Lbar*Vi_up)/(kappa_par_e/Tepara1);
  dw1 = (delty*gamma_e_BC*Va*Lbar*Vi_dw)/(kappa_par_e/Tepara1);
              ...
              if (x[jx][jy] >= xloc)
                {
                  for(int jz=0; jz<mesh->ngz; jz++)
                    {
		      Te_up[jx][jy+1][jz] = ((1.0-up1[jx][jy+1][jz]*(N0[jx][jy+1]+N_up[jx][jy+1][jz])/2.0)*Te[jx][jy][jz] - up1[jx][jy+1][jz]*Te0[jx][jy+1]*N_up[jx][jy+1][jz]);
		      Te_up[jx][jy+1][jz] /= (1.0+up1[jx][jy+1][jz]*(N0[jx][jy+1]+N_up[jx][jy+1][jz])/2.0);
		      Te_dw[jx][jy][jz] = ((1.0-dw1[jx][jy][jz]*(N0[jx][jy]+N_dw[jx][jy][jz])/2.0)*Te[jx][jy+1][jz] - dw1[jx][jy][jz]*Te0[jx][jy]*N_dw[jx][jy][jz]);
		      Te_dw[jx][jy][jz] /= (1.0+dw1[jx][jy][jz]*(N0[jx][jy]+N_dw[jx][jy][jz])/2.0);
                    }
                }
            }
        }
...
void Cal_Ti (const Field3D &Ti, Field3D &Ti_up, Field3D &Ti_dw, Field3D &Vi_up, Field3D &Vi_dw, Field3D &N_up, Field3D &N_dw)
{
  ...
  up1 = (delty*gamma_i_BC*Va*Lbar*Vi_up)/(kappa_par_i/Tipara1);
  dw1 = (delty*gamma_i_BC*Va*Lbar*Vi_dw)/(kappa_par_i/Tipara1);
              ...
              if (x[jx][jy] >= xloc)
                {
                  for(int jz=0; jz<mesh->ngz; jz++)
                    {
		      Ti_up[jx][jy+1][jz] = ((1.0-up1[jx][jy+1][jz]*(N0[jx][jy+1]+N_up[jx][jy+1][jz])/2.0)*Ti[jx][jy][jz] - up1[jx][jy+1][jz]*Ti0[jx][jy+1]*N_up[jx][jy+1][jz]);
		      Ti_up[jx][jy+1][jz] /= (1.0+up1[jx][jy+1][jz]*(N0[jx][jy+1]+N_up[jx][jy+1][jz])/2.0);
		      Ti_dw[jx][jy][jz] = ((1.0-dw1[jx][jy][jz]*(N0[jx][jy]+N_dw[jx][jy][jz])/2.0)*Ti[jx][jy+1][jz] - dw1[jx][jy][jz]*Ti0[jx][jy]*N_dw[jx][jy][jz]);
		      Ti_dw[jx][jy][jz] /= (1.0+dw1[jx][jy][jz]*(N0[jx][jy]+N_dw[jx][jy][jz])/2.0);
                    }
                }
            }
        }
