...
BoutReal tf_coeff;             // The coefficient in front of the thermal_force term. 0.70 for Zeff=1
BoutReal eHall_tf_coeff;       // If >0, the eHall term and thermal force terms are multiplied by this
                               //   coefficient to test the effect of DW.
bool eHall;
...
BoutReal curv_coeff;          // if >0, curvature terms are multiplied by this coefficient
bool include_vipar;
...
int hyperdiff_perp_ydown, hyperdiff_perp_yup;
BoutReal hyperdiff_perp_n4_in, hyperdiff_perp_ti4_in, hyperdiff_perp_te4_in;
BoutReal hyperdiff_perp_v4_in, hyperdiff_perp_u4_in, hyperdiff_perp_apar4_in;
BoutReal hyperdiff_perp_n4_out, hyperdiff_perp_ti4_out, hyperdiff_perp_te4_out;
BoutReal hyperdiff_perp_v4_out, hyperdiff_perp_u4_out, hyperdiff_perp_apar4_out;
Field2D hyperdiff_perp_n4, hyperdiff_perp_ti4, hyperdiff_perp_te4;
Field2D hyperdiff_perp_v4, hyperdiff_perp_apar4, hyperdiff_perp_u4;
...
int physics_init(bool restarting) {
    ...
    OPTION(options, eHall_tf_coeff,           -1);  // If >0, the eHall term and thermal force terms are multiplied by this
                                                        //   coefficient to test the effect of DW.
    ...
    OPTION(options, diamag_U,                false);  // Include nabla_perp^2 Pi term in vorticity?
    ...
    OPTION(options, hyperdiff_perp_ydown,         1);
    OPTION(options, hyperdiff_perp_yup,           2);

    OPTION(options, hyperdiff_perp_n4_in,        -1.0);
    OPTION(options, hyperdiff_perp_ti4_in,        -1.0);
    OPTION(options, hyperdiff_perp_te4_in,        -1.0);
    OPTION(options, hyperdiff_perp_v4_in,        -1.0);
    OPTION(options, hyperdiff_perp_u4_in,        -1.0);
    OPTION(options, hyperdiff_perp_apar4_in,        -1.0);

    OPTION(options, hyperdiff_perp_n4_out,      -1.0);
    OPTION(options, hyperdiff_perp_ti4_out,      -1.0);
    OPTION(options, hyperdiff_perp_te4_out,      -1.0);
    OPTION(options, hyperdiff_perp_v4_out,      -1.0);
    OPTION(options, hyperdiff_perp_u4_out,      -1.0);
    OPTION(options, hyperdiff_perp_apar4_out,      -1.0);
...
//    OPTION(options, hyperdiff_perp_u4,      -1.0);
    ...
    if (thermal_force || eHall) {
        ...
        if (eHall_tf_coeff > 0.0) {
            Psipara1 *= eHall_tf_coeff;
            output.write("                eHall and thermal force terms are multiplied by %e\n", eHall_tf_coeff);
        }
    }
    ...
    if (compresse || compress0) {
        if (include_vipar) {
            output.write("Including Vpar dot grad terms\n");
        }
    } else {
        include_vipar = false;
    }
    if (compress0) {
        compresse = true;
        output.write("compress0 is true. Set compresse to be true");
...
//    }
    ...
    if ((!T0_fake_prof) && n0_fake_prof) {
        ...
        if (impurity_prof) {
            ...
            N0 = P0 / (Tau_ie * Ti0 + Zi * Te0);
            Ne0 = Zi * N0;
            N_imp0 = 0;
        } else {
            Ne0 = Zi * N0; // quasi-neutral condition
            P0 = Tau_ie * N0 * Ti0 + Ne0 * Te0;
            N_imp0 = 0;
        }
    }
...
//            kappa_par_e_fl = q_alpha * vth_e * q95 * Lbar;
    ...
    dump.add(Pi, "Pi", 1);
    dump.add(Delp2Pi, "Delp2Pi", 1);

    hyperdiff_perp_n4 = 0.0;
    hyperdiff_perp_ti4 = 0.0;
    hyperdiff_perp_te4 = 0.0;
    hyperdiff_perp_v4 = 0.0;
    hyperdiff_perp_u4 = 0.0;
    hyperdiff_perp_apar4 = 0.0;
    for (jx=0; jx < mesh->ngx; jx++) {
        for (jy=0; jy < mesh->ngy; jy++) {
            indy = mesh->YGLOBAL(jy);
            if ((indy >= hyperdiff_perp_ydown) && (indy <= hyperdiff_perp_yup)) {
                if (hyperdiff_perp_n4_in > 0.0) {
                    hyperdiff_perp_n4[jx][jy] = hyperdiff_perp_n4_in;
                }
                if (hyperdiff_perp_ti4_in > 0.0) {
                    hyperdiff_perp_ti4[jx][jy] = hyperdiff_perp_ti4_in;
                }
                if (hyperdiff_perp_te4_in > 0.0) {
                    hyperdiff_perp_te4[jx][jy] = hyperdiff_perp_te4_in;
                }
                if (hyperdiff_perp_v4_in > 0.0) {
                    hyperdiff_perp_v4[jx][jy] = hyperdiff_perp_v4_in;
                }
                if (hyperdiff_perp_u4_in > 0.0) {
                    hyperdiff_perp_u4[jx][jy] = hyperdiff_perp_u4_in;
                }
                if (hyperdiff_perp_apar4_in > 0.0) {
                    hyperdiff_perp_apar4[jx][jy] = hyperdiff_perp_apar4_in;
                }
            } else {
                if (hyperdiff_perp_n4_out > 0.0) {
                    hyperdiff_perp_n4[jx][jy] = hyperdiff_perp_n4_out;
                }
                if (hyperdiff_perp_ti4_out > 0.0) {
                    hyperdiff_perp_ti4[jx][jy] = hyperdiff_perp_ti4_out;
                }
                if (hyperdiff_perp_te4_out > 0.0) {
                    hyperdiff_perp_te4[jx][jy] = hyperdiff_perp_te4_out;
                }
                if (hyperdiff_perp_v4_out > 0.0) {
                    hyperdiff_perp_v4[jx][jy] = hyperdiff_perp_v4_out;
                }
                if (hyperdiff_perp_u4_out > 0.0) {
                    hyperdiff_perp_u4[jx][jy] = hyperdiff_perp_u4_out;
                }
                if (hyperdiff_perp_apar4_out > 0.0) {
                    hyperdiff_perp_apar4[jx][jy] = hyperdiff_perp_apar4_out;
                }
            }
        }
    }
    hyperdiff_perp_n4.applyBoundary("neumann");
    hyperdiff_perp_ti4.applyBoundary("neumann");
    hyperdiff_perp_te4.applyBoundary("neumann");
    hyperdiff_perp_v4.applyBoundary("neumann");
    hyperdiff_perp_u4.applyBoundary("neumann");
    hyperdiff_perp_apar4.applyBoundary("neumann");
    mesh->communicate(hyperdiff_perp_n4);
    mesh->communicate(hyperdiff_perp_ti4);
    mesh->communicate(hyperdiff_perp_te4);
    mesh->communicate(hyperdiff_perp_v4);
    mesh->communicate(hyperdiff_perp_u4);
    mesh->communicate(hyperdiff_perp_apar4);
    SAVE_ONCE(hyperdiff_perp_n4);
    SAVE_ONCE(hyperdiff_perp_ti4);
    SAVE_ONCE(hyperdiff_perp_te4);
    SAVE_ONCE(hyperdiff_perp_v4);
    SAVE_ONCE(hyperdiff_perp_u4);
    SAVE_ONCE(hyperdiff_perp_apar4);
...
//    SOLVE_FOR(Vn);
  ...
  */
    ...
    if (BScurrent || neo_resist) {
        ...
        nu_estar = Zeff * nu_e * q95 * major_radius * Lbar / (vth_e) / pow(epsilon, 1.5);
...
//        nu_istar = 100. * nu_i * q95 * Lbar / (vth_i) / pow(epsilon, 1.5);
    ...
    if (hyperdiff_par_u4 > 0.0 || hyperdiff_perp_u4_in > 0.0 || hyperdiff_perp_u4_out > 0.0)
        tmpU2.setBoundary("U");

    if (hyperdiff_par_apar4 > 0.0 || hyperdiff_perp_apar4_in > 0.0 || hyperdiff_perp_apar4_out > 0.0)
        tmpA2.setBoundary("J");

    if (hyperdiff_par_n4 > 0.0 || hyperdiff_perp_n4_in > 0.0 || hyperdiff_perp_n4_out > 0.0)
        tmpN2.setBoundary("Ni");

    if (hyperdiff_par_ti4 > 0.0 || hyperdiff_perp_ti4_in > 0.0 || hyperdiff_perp_ti4_out > 0.0)
        tmpTi2.setBoundary("Ti");

    if (hyperdiff_par_te4 > 0.0 || hyperdiff_perp_te4_in > 0.0 || hyperdiff_perp_te4_out > 0.0)
        tmpTe2.setBoundary("Te");

    if (hyperdiff_par_v4 > 0.0 || hyperdiff_perp_v4_in > 0.0 || hyperdiff_perp_v4_out > 0.0)
...
/*  if (diffusion_par && Landau) {
    ...
    if (thermal_force) {
      phi_sh += tf_coeff * Psipara1 * Grad_parP(Te, CELL_YLOW) / B0;
      phi_sh -= tf_coeff * Psipara1 * bracket(Psi, Te0, bm_mag);
    }
    */
        ...
        if (evolve_psi) {
            ...
            if (thermal_force) {
                phi_sh += tf_coeff * Psipara1 * Grad_parP(Te, CELL_YLOW);
                phi_sh -= tf_coeff * Psipara1 * bracket(Apar, Te0, bm_mag);
            }
        }
...
*/
    ...
    if (!emass) {
      ...
      */
            ...
            if (thermal_force) {
                ...
                ddt(Psi) += tf_coeff * Psipara1 * Grad_parP(Te, CELL_YLOW) / B0;
                ddt(Psi) -= tf_coeff * Psipara1 * bracket(Psi, Te0, bm_mag);
            }
            ...
            if (hyperdiff_perp_apar4_in > 0.0 || hyperdiff_perp_apar4_out > 0.0) {
                tmpA2 = Delp2(Psi);
                mesh->communicate(tmpA2);
                tmpA2.applyBoundary();
                ddt(Psi) -= hyperdiff_perp_apar4 * Delp2(tmpA2);
            }
            if (sink_Psir > 0.0) {
            ...
            if (thermal_force) {
                // grad_par(T_e) correction
                ddt(Apar) += tf_coeff * Psipara1 * Grad_parP(Te, CELL_YLOW);
                ddt(Apar) -= tf_coeff * Psipara1 * bracket(Apar, Te0, bm_mag);
            }
            ...
            if (hyperdiff_perp_apar4_in > 0.0 || hyperdiff_perp_apar4_out > 0.0) {
                ...
                mesh->communicate(tmpA2);
                tmpA2.applyBoundary();
                ddt(Apar) -= hyperdiff_perp_apar4 * Delp2(tmpA2);
            }
            if (sink_Psir > 0.0) {
        ...
        if (thermal_force) {
            // grad_par(T_e) correction
            ddt(Ajpar) += tf_coeff * Psipara1 * Grad_parP(Te, CELL_YLOW) / B0;
            ddt(Ajpar) -= tf_coeff * Psipara1 * bracket(Psi, Te0, bm_mag);
        }
    ...
    if (output_ohm) {
        ...
        if (evolve_psi) {
            ohm_thermal = tf_coeff * Psipara1 * (Grad_parP(Te, CELL_YLOW) / B0 - bracket(Psi, Te0, bm_mag));
        } else {
            ohm_thermal = tf_coeff * Psipara1 * (Grad_parP(Te, CELL_YLOW) / B0 - bracket(Apar, Te0, bm_mag));
        }
    ...
    if (hyperdiff_perp_u4_in > 0.0 || hyperdiff_perp_u4_out > 0.0) {
        tmpU2 = Delp2(U);
        mesh->communicate(tmpU2);
        tmpU2.applyBoundary();
  ...
  */
    ...
    if (hyperdiff_perp_n4_in > 0.0 || hyperdiff_perp_n4_out > 0.0) {
        tmpN2 = Delp2(Ni);
        mesh->communicate(tmpN2);
        tmpN2.applyBoundary();
    ...
    if (hyperdiff_perp_ti4_in > 0.0 || hyperdiff_perp_ti4_out > 0.0) {
        tmpTi2 = Delp2(Ti);
        mesh->communicate(tmpTi2);
        tmpTi2.applyBoundary();
    ...
    if (energy_flux) {
        ...
        if (thermal_force) {
            ddt(Te) += tf_coeff * 2.0 / 3.0 * Tepara3 * Te0 * B0 / Ne0 * Grad_parP(Jpar / B0, CELL_CENTRE);
            if (BScurrent) {
                if (evolve_psi)
                    ddt(Te) -= tf_coeff * 2.0 / 3.0 * Tepara3 * Te0 * B0 / Ne0 * bracket(Psi, Jpar_BS0 / B0, bm_mag) * B0;
                else
                    ddt(Te) -= tf_coeff * 2.0 / 3.0 * Tepara3 * Te0 * B0 / Ne0 * bracket(Apar, Jpar_BS0 / B0, bm_mag);
                ddt(Te) += tf_coeff * 2.0 / 3.0 * Tepara3 * Te * B0 / Ne0 * Grad_parP(Jpar_BS0 / B0, CELL_CENTRE);
            } else {
                if (evolve_psi)
                    ddt(Te) -= tf_coeff * 2.0 / 3.0 * Tepara3 * Te0 * B0 / Ne0 * bracket(Psi, J0 / B0, bm_mag) * B0;
                else
                    ddt(Te) -= tf_coeff * 2.0 / 3.0 * Tepara3 * Te0 * B0 / Ne0 * bracket(Apar, J0 / B0, bm_mag);
                ddt(Te) += tf_coeff * 2.0 / 3.0 * Tepara3 * Te * B0 / Ne0 * Grad_parP(J0 / B0, CELL_CENTRE);
            }
        }
        if (nonlinear) {
            ...
            if (thermal_force)
                ddt(Te) += tf_coeff * 2.0 / 3.0 * Tepara3 * Te * B0 / Ne0 * Grad_par(Jpar / B0, CELL_CENTRE);
        }
    }
    ...
    if (hyperdiff_perp_te4_in > 0.0 || hyperdiff_perp_te4_out > 0.0) {
        tmpTe2 = Delp2(Te);
        mesh->communicate(tmpTe2);
        tmpTe2.applyBoundary();
    ...
    if (compress0) // parallel velocity equation
    {
        ...
        if (hyperdiff_perp_v4_in > 0.0 || hyperdiff_perp_v4_out > 0.0) {
            tmpVp2 = Delp2(Vipar);
            mesh->communicate(tmpVp2);
            tmpVp2.applyBoundary();
