function [output] = next_double(fid)
% NEXT_DOUBLE short description
% SYNTAX
% [output] = NEXT_DOUBLE(A)
%
% INPUT PARAMETERS
...
%
% DESCRIPTION
% Exhaustive and long description of functionality of next_double.
%
% Examples:
% description of example for next_double
% >> [output] = next_double(A);
%
% See also:
% ALSO1, ALSO2
...
% $Revision: 1.0$ Created on: 26-May-2015 18:14:34
