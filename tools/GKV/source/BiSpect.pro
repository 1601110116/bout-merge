PRO GKV_DeTrend, signal, t, order=iorder, coeffs=coeffs
;
;  Purpose:
;
...
FUNCTION GKVs2D::DeTrend, order=iorder, coeffs=coeffs
;
;
; Purpose:
;
...
FUNCTION GKVs1D::DeTrend, order=iorder, coeffs=coeffs
;
; Purpose:
;
...
GKV_DeTrend, values, t, order=iorder, coeffs=coeffs
...
; Purpose:
;
;	This function performs a bispectral analysis of the data in
