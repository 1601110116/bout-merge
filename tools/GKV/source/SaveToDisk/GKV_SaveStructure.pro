...
;	4/13/01
;
FORWARD_FUNCTION GKV_SAVESTRUCTURE 
FORWARD_FUNCTION GKV_RESTORESTRUCTURE 
FORWARD_FUNCTION GKV_RESTOREARRAY 
FORWARD_FUNCTION GKV_RESTORE
...
; (follows suggestion from RSI support in E-Mail of 1/2/04
;
version = FLOAT(!VERSION.RELEASE)
IF( (!D.NAME EQ 'MAC') AND (version LT 5.5) ) THEN BEGIN
	dirNames = FINDFILE("*_arr", COUNT=nDirs)
ENDIF ELSE BEGIN
	dirNames = FILE_SEARCH("*_arr", COUNT=nDirs, /TEST_DIRECTORY)
ENDELSE
