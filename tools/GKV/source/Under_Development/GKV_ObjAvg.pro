...
avgValues = avgValues/nObjs				; Compute average
avg -> Set, values=PTR_NEW(avgValues)

avgValuesSQ = avgValuesSq/nObjs				; Compute standard deviation
