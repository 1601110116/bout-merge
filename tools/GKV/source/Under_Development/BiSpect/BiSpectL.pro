...
FUNCTION GKVs1D::BiSpectL, arg1, arg2, 	dw=ddw, Idw=idataWindow, 	$
...
FUNCTION GKVs2D::BiSpectL, arg1, arg2, 	dw=ddw, Idw=idataWindow, 	$
					lw=llw, ilw=iLagWindow, order = iorder
;
; Purpose:
;
;	Dummy routine to short-stop attempts to 
;	call BiSpectL on data with dimensionality 
;	greater than 1.
;
; Written by W.M. Nevins
;	7/6/01
;
MESSAGE, 'BiSpectL only implimented for 1-D objects', /INFORMATIONAL
RETURN, 0
END ; ****** GKVs2D::BiSpectL ****** ;